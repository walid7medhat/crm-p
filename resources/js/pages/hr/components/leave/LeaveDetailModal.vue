  ...
  <div v-if="visible && row" class="edit-overlay" @click.self="handlers.closeLeaveDetails">
    <div class="leave-detail-modal">
      ...
      <div class="leave-detail-grid">
        ...
        <p><span>Start Date</span><strong>{{ row.startDate }}</strong></p><p><span>End Date</span><strong>{{ row.endDate }}</strong></p>
...
<script setup>
defineProps({ visible: Boolean, row: Object, handlers: Object })
</script>
