...
// Watch for current user avatar changes to reset avatar error
...
const handleSave = async () => {
    try {
        ...
        // Use reminderDate if set, otherwise use selectedDateTime (default to today + current time)
