...
const handleDealCreatedFromLeads = async (createdDeal) => {
    ...
    // Open the deal modal immediately — waiting on the full deals board fetch
    // was delaying Buyer Details ("Loading form...") after lead conversion.
    await nextTick()
    ...
    if (dealsComponent?.fetchDeals) {
        dealsComponent.fetchDeals(true).catch((e) => {
