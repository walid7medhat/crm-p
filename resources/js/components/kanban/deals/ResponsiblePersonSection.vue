    ...
    <div class="responsible-card bg-white p-3 radius-12 shadow-sm mt-3">
        ...
        <div class="info-group">
            ...
            <div class="d-flex align-items-center gap-3">
                <div class="avatar-wrapper person-hover-anchor" @mouseenter="showPersonCard = true" @mouseleave="showPersonCard = false" @click.stop="openPersonProfile(deal, 'responsible', $event)">
                    <img
                    ...
                    <transition name="person-card-pop">
                        <div v-if="showPersonCard" class="person-hover-card">
                            <div class="person-hover-head">
                                ...
                                <div>
                                    <div class="person-hover-name">{{ deal?.responsible_person?.name || '—' }}</div>
            ...
            <div class="person-modal-content">
                ...
                <div v-else class="person-list-scroll">
                    <div
                        ...
                        :class="{ 'selected': selectedPersonId === user.id, 'current': deal?.responsible_person?.id === user.id }"
                    >
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <span v-if="deal?.responsible_person?.id === user.id" class="current-badge">Current</span>
                ...
                <div class="modal-footer-custom mt-3">
                    ...
                    <b-button
                        ...
                        :disabled="!selectedPersonId || isUpdatingPerson || selectedPersonId === deal?.responsible_person?.id"
                    >
...
const fetchAvailablePersons = async (search = '') => {
    ...
    try {
        ...
        if (props.deal?.responsible_person?.id) params.selected_id = props.deal.responsible_person.id
...
const openPersonModal = () => {
    selectedPersonId.value = props.deal?.responsible_person?.id || null
...
const updateResponsiblePerson = async () => {
    ...
    personUpdateError.value = ''
    try {
        await api.post(`/deals/${props.deal.id}/assign-responsible-person`, {
