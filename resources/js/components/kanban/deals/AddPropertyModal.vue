  ...
  >
    <div class="p-3">
      <div class="row g-3">
        ...
        <!-- Bedrooms - يختفي لو Land أو Plot -->
      ...
      <div class="d-flex justify-content-end gap-3 mt-4">
        ...
        <button class="btn-save" @click="saveProperty" :disabled="saving">
...
// Bedrooms visibility - يختفي لو Land أو Plot
...
// لو اختار Land أو Plot، نحذف قيمة الـ bedrooms
watch(() => formData.value.property_type_id, (newTypeId) => {
