...
const showDealNotification = (event) => {
  ...
  const themes = {
    ...
    revert:        { grad: 'linear-gradient(135deg,#fbbf24,#d97706)', accent: '#f59e0b', soft: 'rgba(245,158,11,.14)', ring: 'rgba(245,158,11,.5)',  icon: svg.revert,        headline: `<b>${userName}</b> reverted` },
