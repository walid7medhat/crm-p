<template>
  <div class="row g-4 p-4">
    ...
    <div class="col-12">
      ...
      <div class="form-card p-3 radius-12">
        <div class="row g-3">
          ...
          <div class="col-md-4">
            <label class="form-label-custom">Buyer Country Of Residence</label>
    ...
    <!-- Upload Secondary Buyer Documents -->
    <div class="col-12">
      <h6 class="section-title mb-3">Upload Secondary Buyer Documents</h6>
      <div class="form-card p-3 radius-12">
    ...
    <div class="col-12">
      ...
      <div class="form-card p-3 radius-12">
        <div class="row g-3">
          <div class="col-md-4">
            <label class="form-label-custom">Seller First Name <span class="text-danger">*</span></label>
            <b-form-input v-model="form.seller_first_name" placeholder="Enter First Name" class="custom-input" />
          </div>
          <div class="col-md-4">
            <label class="form-label-custom">Seller Last Name <span class="text-danger">*</span></label>
          ...
          <div class="col-md-4">
            ...
            <b-form-input v-model="form.seller_phone" placeholder="Enter Phone Number" class="custom-input" />
          </div>
          <div class="col-md-4">
            <label class="form-label-custom">Seller Email <span class="text-danger">*</span></label>
            <b-form-input v-model="form.seller_email" type="email" placeholder="Enter Your Email" class="custom-input" />
          </div>
          <div class="col-md-4">
            <label class="form-label-custom">Seller City Of Residence <span class="text-danger">*</span></label>
            <b-form-input v-model="form.seller_city" placeholder="Enter City" class="custom-input" />
          </div>
          <div class="col-md-4">
            <label class="form-label-custom">Seller Language <span class="text-danger">*</span></label>
            <v-select v-model="form.seller_language" :options="languageOptions" :reduce="o => o.value" label="text" placeholder="Select Language" class="custom-v-select" />
          </div>
        </div>
      </div>
    </div>

    <!-- Upload Secondary Seller Documents -->
    <div class="col-12">
      <h6 class="section-title mb-3">Upload Secondary Seller Documents</h6>
      <div class="form-card p-3 radius-12">
        <div class="doc-tabs d-flex gap-2 mb-3 flex-wrap">
          <button v-for="t in sellerDocTabs" :key="t.id" class="doc-tab" :class="{ active: form.seller_doc_type === t.id }" @click="setDocType('seller_doc_type', t.id)">{{ t.name }}</button>
        </div>
        <div class="upload-zone border rounded p-4 text-center">
          <iconify-icon icon="lucide:cloud-upload" class="upload-icon"></iconify-icon>
          <p class="upload-text mb-2">Drag and drop your files</p>
...
const form = computed({
  get: () => ({ buyer_doc_type: 'national_id', seller_doc_type: 'national_id', ...props.modelValue }),
...
const buyerDocTabs = [
  ...
  { id: 'visa', name: 'Buyer Visa' },
  { id: 'kyc', name: 'Buyer KYC' },
  { id: 'payment_proof', name: 'Buyer Payment Proof' },
  { id: 'title_deed', name: 'New Title Deed / New SPA' }
]

const sellerDocTabs = [
  { id: 'national_id', name: 'Seller National ID' },
  { id: 'passport', name: 'Seller Passport' },
  { id: 'unit_spa', name: 'Unit SPA / Tittle Deed' }
]
