...
Route::middleware(['jwt.auth'])->group(function () {
  ...
  Route::get('/dashboard/property-types-with-listings', [DashboardController::class, 'getPropertyTypesWithListings']);
   ...
   Route::get('/sidebar/counts', [DashboardController::class, 'getSidebarCounts']);
    ...
    Route::get('/profile/emergency-contact', [ProfileController::class, 'getEmergencyContact']);
...
Route::post('{id}/duplicate', [ListingController::class, 'duplicate']);
    ...
    Route::get('/properties/{listing}/approved-viewings', [ListingAccessRequestController::class, 'listingApprovedViewings']);
